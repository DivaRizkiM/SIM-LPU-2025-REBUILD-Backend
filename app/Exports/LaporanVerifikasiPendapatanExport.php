...
class LaporanVerifikasiPendapatanExport implements WithEvents
{
    protected $data;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                // header('Content-Disposition: attachment;filename="laporan-verifikasdddddi-pendapatan.xlsx"');
                ...
                // $writer = new \PhpOffice\PhpSpreadsheet\Writer\Xlsx($spreadsheet);
                // header('Content-Type: application/vnd.ms-excel');
                // header('Content-Disposition: attachment;filename="laporan-verifikasi-biaya.xlsx"');
                // header('Cache-Control: max-age=0');
                // $writer->save('php://output');
                exit;
            },
