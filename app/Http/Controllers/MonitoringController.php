...
class MonitoringController extends Controller
{
    public function index(Request $request)
    {
        try {
            ...
            // Backward compatible: terima id_kpc atau id_rekonsiliasi dari FE
            ...
            if (in_array($type_penyelenggara, ['lpu', 'lpk'], true)) {
                ...
                if ($id_kpc_param)       $query->where('kpc.id', $id_kpc_param);
            } else {
                // --- Cabang Penyelenggara lain (tabel Rekonsiliasi) ---
