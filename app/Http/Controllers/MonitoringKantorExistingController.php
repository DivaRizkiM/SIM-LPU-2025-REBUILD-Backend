...
class MonitoringKantorExistingController extends Controller
{
    public function index(Request $request)
    {
        try {
            ...
            $query = PencatatanKantor::select([
                ...
                ->where('pencatatan_kantor.jenis', 'Monitoring Kantor Eksisting')
...
$total_data = $query->count();
            ...
            foreach ($result as $item) {
                ...
                $data[] = [
                    ...
                    'aspek_keuangan' => round($item->aspek_keuangan),
    ...
    public function export(Request $request)
    {
        try {
            ...
            $userLog=[
                'timestamp' => now(),
                'aktifitas' =>'Cetak Monitoring Kantor Existing',
                'modul' => 'Monitoring Kantor Existing',
                'id_user' => Auth::user(),
            ];
