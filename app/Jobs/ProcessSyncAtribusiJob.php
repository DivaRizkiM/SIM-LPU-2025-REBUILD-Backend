...
class ProcessSyncAtribusiJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            // ✅ Tandai log sebagai gagal jika sudah dibuat
            if ($apiRequestLog) {
            ...
            // ✅ Log detail error
            Log::error('Job ProcessSyncAtribusiJob gagal: ' . $e->getMessage(), [
                'trace' => $e->getTraceAsString(),
            ]);

            // ✅ Tetap lempar error agar Laravel tandai job sebagai gagal
            throw $e;
        }
    }
