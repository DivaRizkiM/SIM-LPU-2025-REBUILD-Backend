                        ...
                        <div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                           <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                              ...
                              <tr>
                                 <td align="left" style="font-size:0px;padding:0px 15px 5px 15px;word-break:break-word;">
                                    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1.5;text-align:left;color:#000000;">
                                       <p style="text-align: center;"><span style="font-size: 12px; font-family: arial, sans-serif;"><strong>PENARIKAN DATA PENYELENGGARAAN LAYANAN POS UNIVERSAL <?php echo e($user_identity); ?></strong></span></p>
                                    </div>
                                 </td>
                              </tr>
                              <tr>
                                 <td align="left" style="font-size:0px;padding:0px 15px 5px 15px;word-break:break-word;">
                                    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1.5;text-align:left;color:#000000;">
                                       <p style="text-align: center;transform: uppercase;"><span style="font-size: 12px; font-family: arial, sans-serif; text-transform: uppercase;"><strong >BULAN <?php echo e($nama_bulan); ?>TAHUN ANGGARAN <?php echo e($tahun_anggaran); ?></strong></span></p>
                                    </div>
                                 </td>
                              </tr>
                           </table>
                                 ...
                                 <td align="left" style="font-size:0px;padding:25px 15px 5px 15px;word-break:break-word;">
                                    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1.5;text-align:left;color:#000000;">
                                       <p style="text-align: justify;"><span style="font-size: 13px;"> &nbsp; &nbsp; &nbsp; &nbsp; Pada hari ini,
                                        <!-- <b><?php echo e($terbilangTgl_kuasa); ?></b>, -->
                                        <b><?php echo e($tanggal_kuasa); ?>,</b>
                                         telah dilakukan penarikan data Layanan Pos Universal Bulan <?php echo e($nama_bulan); ?> Tahun <?php echo e(substr($tanggal, 0, 4)); ?>.
                                       <br> &nbsp; &nbsp;
                                       Dari hasil penarikan data Penyelenggaraan Layanan Pos Universal Bulan <?php echo e($nama_bulan); ?> Tahun Anggaran <?php echo e($tahun_anggaran); ?>, telah dilakukan penarikan data terhadap data-data sebagai berikut:</span></p>
                                    </div>
                                 </td>
                              </tr>
                           </table>
         ...
         <div style="Margin:0px auto;max-width:600px;">
            <table align="center" border="1px" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;margin-top: 10px;">
               <tbody>
                  ...
                  <?php $__currentLoopData = $biaya; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="bordered" style="font-size:12px;padding:5px 5px 5px 5px;word-break:break-word;text-align:justify;color: #000000;border:1px solid #000000;">
                            <b><?php echo e($row->nama_regional); ?></b>
                        </td>
                        <td class="bordered" style="font-size:12px;padding:5px 5px 5px 5px;word-break:break-word;text-align:justify;color: #000000;border:1px solid #000000;">
                            Rp. <?php echo e(number_format($row->total_biaya_regional, 0, ',', '.')); ?>

                        </td>
                        <td class="bordered" style="font-size:12px;padding:5px 5px 5px 5px;word-break:break-word;text-align:justify;color: #000000;border:1px solid #000000;">
                            Rp. <?php echo e(number_format($row->pendapatan_regional, 0, ',', '.')); ?>
                        ...
                        <td class="bordered" style="font-size:12px;padding:5px 5px 5px 5px;word-break:break-word;text-align:justify;color: #000000;border:1px solid #000000;">
                            ...
                            ?>
                            Rp. <?php echo e(number_format($deviasi, 0, ',', '.')); ?>
                  ...
                  <tr>
                     ...
                     Rp. <?php echo e(number_format($total_biaya, 0, ',', '.')); ?>
                     ...
                     <td class="bordered" style="font-size:12px;padding:5px 5px 5px 5px;text-align:justify;color: #000000;border:1px solid #000000;">
                     Rp. <?php echo e(number_format($total_deviasi, 0, ',', '.')); ?>
                           ...
                           <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-top:0px #000000 solid;vertical-align:top;" width="100%">
                              <tr>
                                 <td align="left" style="font-size:0px;padding:25px 15px 5px 15px;word-break:break-word;">
                                    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1.5;text-align:left;color:#000000;">
                                       &nbsp; &nbsp;
                                       Demikian Berita Acara ini dibuat untuk digunakan sebagai pedoman pelaksanaan verifikasi Penyelenggaraan Layanan Pos Universal Bulan <?php echo e($nama_bulan); ?> Tahun Anggaran <?php echo e(substr($tanggal, 0, 4)); ?></span></p>
                                    </div>
                                 </td>
                              </tr>
                           </table>
...
<?php /**PATH /var/www/backend/resources/views/berita-acara/penarikan.blade.php ENDPATH**/ ?>